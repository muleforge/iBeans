 ...
 * scanned and used to create the context.  Typicilally this class will be used to create resolvers for binding frameworks
...
{
    public static final String[] ignorredPackages = {"java.", "javax.", "org.w3c.", "org.mule.transport.", "org.mule.module."};
    ...
    protected boolean findAnnotation(Class annotatedType) throws IOException
    {
        ...
        for (String ignorredPackage : ignorredPackages)
        {
            if(annotatedType.getPackage().getName().startsWith(ignorredPackage))
            {
                return false;
            }
        }
