...
/**
 * Responsible for parsing the {@link org.mule.ibeans.api.application.params.SendHeaders} annotation.  This is an iBeans
 * framework class and cannot be used in any other context.
 */
public class SendHeadersAnnotationParser implements ExpressionParser
{
    ...
    {
        return annotation instanceof SendHeaders;
    }
}