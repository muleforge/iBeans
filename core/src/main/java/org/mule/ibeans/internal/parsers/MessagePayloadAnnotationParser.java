...
/**
 * Responsible for parsing the {@link org.mule.ibeans.api.application.params.MessagePayload} annotation.  This is an iBeans
 * framework class and cannot be used in any other context.
 */
public class MessagePayloadAnnotationParser implements ExpressionParser
{
    ...
    {
        return annotation instanceof MessagePayload;
    }
}