...
public class ScheduleConfigBuilder implements NamedObject
{
    ...
    public ScheduleConfigBuilder(String scheduleId, MuleContext muleContext) throws IBeansException
    {
        super();
    ...
    public InboundEndpoint buildScheduler() throws IBeansException
    {
        try
        {
