 ...
 * TODO
 */
public class IBeansJndiContext implements Context, Serializable
{
    ...
    public IBeansJndiContext() {
        environment = new Hashtable();
        bindings = new HashMap();
        treeBindings = new HashMap();
    }

    public IBeansJndiContext(Hashtable env) {
        if (env == null) {
    ...
    public IBeansJndiContext(Hashtable environment, Map bindings) {
        if (environment == null) {
            this.environment = new Hashtable();
        }
        else {
    ...
    public IBeansJndiContext(Hashtable environment, Map bindings, String nameInNamespace) {
        this(environment, bindings);
        this.nameInNamespace = nameInNamespace;
    }

    protected IBeansJndiContext(IBeansJndiContext clone, Hashtable env) {
        this.bindings = clone.bindings;
        this.treeBindings = clone.treeBindings;
        this.environment = new Hashtable(env);
    }

    protected IBeansJndiContext(IBeansJndiContext clone, Hashtable env, String nameInNamespace) {
        this(clone, env);
        this.nameInNamespace = nameInNamespace;
    }
    ...
    public Object lookup(String name) throws NamingException {
        ...
        if (result instanceof IBeansJndiContext) {
            String prefix = getNameInNamespace();
            if (prefix.length() > 0) {
                prefix = prefix + SEPARATOR;
            }
            result = new IBeansJndiContext((IBeansJndiContext) result, environment, prefix + name);
        }
        return result;
    }
    ...
    public NamingEnumeration list(String name) throws NamingException {
        ...
        if (o == this) {
            return new IBeansJndiContext.ListEnumeration();
        }
    ...
    public NamingEnumeration listBindings(String name) throws NamingException {
        Object o = lookup(name);
        if (o == this) {
            return new IBeansJndiContext.ListBindingEnumeration();
        }
        else if (o instanceof Context) {
    ...
    private class ListEnumeration extends IBeansJndiContext.LocalNamingEnumeration {
    ...
    private class ListBindingEnumeration extends IBeansJndiContext.LocalNamingEnumeration {
        public Object next() throws NamingException {
            return nextElement();
        }
    ...
    protected Map internalBind(String name, Object value, boolean allowRebind) throws NamingException
    {
        ...
        else
        {
            ...
            else if (!(o instanceof IBeansJndiContext))
            {
                throw new NamingException("Something already bound where a subcontext should go");
            }
            IBeansJndiContext defaultContext = (IBeansJndiContext) o;
    ...
    protected IBeansJndiContext newContext() {
        return new IBeansJndiContext();
    }
