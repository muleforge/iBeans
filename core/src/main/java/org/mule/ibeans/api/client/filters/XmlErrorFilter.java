 ...
 * <p/>
 * This filter is only used on responses that have an 'application/xml' mime type. The expression for this filter is an
...
public @interface XmlErrorFilter
{
    ...
    String mimeType() default MimeTypes.XML;
