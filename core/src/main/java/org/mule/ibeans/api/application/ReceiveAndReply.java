...
/**
 * This annotations exposes a method for request-response invocations (RPC) over the given URI channel.
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Channel(identifer = "receive-reply", type = ChannelType.Inbound)
@SupportedMEPs(MEP.InOut)
public @interface ReceiveAndReply
{
    /**
     ...
     * example:
     * <code>@ReceiveAndReply(uri = "${my.channel}")</code>
