...
public @interface Schedule
{
     ...
     * {@link ScheduleConfigBuilder}, whereas builders stored in the Mule service registry need to use the path to the configuration
     * prefixed with 'galaxy:'  to tell iBeans it needs to go to a remote service registry. For example:
     * <code>
