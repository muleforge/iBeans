...
/**
 * The exception type to throw on methods that are annotated with the {@link org.mule.ibeans.api.client.Call} annotation.
...
public class CallException extends Exception
{
    ...
    public String toString()
    {
        return "CallException{" + getMessage() +
                ", errorCode='" + errorCode + '\'' +
                ", info=" + StringMessageUtils.toString(info) +
                '}';
    }
}
