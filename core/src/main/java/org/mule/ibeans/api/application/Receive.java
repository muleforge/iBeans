...
/**
 * An annotation that allows you to receive messages on channels made available by Mule, such as JMS, IMAP (Email),
 * and XMPP. This annotation provides one-way communication. For two-way communications, use the {@link ReceiveAndReply} annotation.
 * <p/>
 ...
 * that builder using the config argument on the Receive iBean.
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Channel(identifer = "receive", type = ChannelType.Inbound)
@SupportedMEPs(MEP.InOnly)
public @interface Receive
{
     ...
     * example:
     * <code>@Receive(uri = "${my.channel}")</code>
