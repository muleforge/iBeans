...
@Documented
@Channel(identifer = "vm", type = ChannelType.Outbound)
@SupportedMEPs({MEP.OutOnly, MEP.OutOptionalIn, MEP.OutIn})
public @interface VmOutbound
{
    /**
     ...
     */
    public abstract boolean queueEvents() default false;
     ...
     */
    public abstract String properties() default "";
