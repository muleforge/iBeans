...
import org.mule.ibeans.example.bookstore.web.HtmlTemplate;
 ...
 */
@Service(name = "DataWarehouseService")
@In(uri = "vm://dataWarehouse", mep = MEP.InOnly)
public class DataWarehouse
{
    ...
    @Out(uri = "vm://statistics", mep = MEP.OutOnly, properties = "Content-Type=text/html")
