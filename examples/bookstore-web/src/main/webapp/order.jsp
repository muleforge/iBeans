...
<form method="POST" name="submitRequest" action="/services/order/book">
    <table>
        <tr>
            <td>Title: </td>
            <td><input type="text" name="title" readonly="true" value="<%=book.getTitle()%>"/></td>
           </tr>
        <tr>
            <td>Author: </td>
            <td><input type="text" name="author" readonly="true" value="<%=book.getAuthor()%>"/></td>
        </tr>
        <tr>
            <td>Price: </td>
            <td><input type="text" name="price" readonly="true" value="<%=book.getPrice()%>"/></td>
        </tr>
        <tr>
            <td>Quantity: </td>
