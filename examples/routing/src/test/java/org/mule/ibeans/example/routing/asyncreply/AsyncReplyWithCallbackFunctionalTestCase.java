 ...
 */
public class AsyncReplyWithCallbackFunctionalTestCase extends AbstractIBeansTestCase
{
    protected void doSetUp() throws Exception
    {
        registerBeans(new ClientProxyWithCallback());
    ...
    public void testReplyTo() throws Exception
    {
        ...
        assertEquals("devieceR ssoR Callback", result);
    }
}