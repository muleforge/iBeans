...
import org.mule.ibeans.aws.ec2.EC2IBean;
 ...
 */
public class EC2SignatureFactory implements ParamFactory
{
    ...
    public String create(String paramName, boolean optional, InvocationContext invocationContext)
    {
        ...
        {
            // hash it all!
            Mac mac = Mac.getInstance(EC2IBean.DEFAULT_SIGNATURE_METHOD);
